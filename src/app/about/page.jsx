            ...
            <div className='h-full flex flex-col gap-10'>
                <div className='flex flex-col gap-16'>
                    ...
                    <div className='flex flex-col gap-2'>
                        <div className='md:flex-row lg:flex-row flex flex-col gap-6'>
                            ...
                            <div className='flex gap-2 text-slate-700 text-sm'>
                                <p className='ml-1'>Aftereffect</p> <p>|</p> <p>Video Editing</p> <p>|</p> <p>Lightning</p> <p>|</p> <p>Blender</p> <p>|</p> <p>TV Paint</p>
                            </div>
                        </div>
                        <div className='md:flex-row lg:flex-row flex flex-col gap-6'>
                            <div className='flex gap-2 text-slate-700 text-sm'>
